...
from lumen.analyze_data.analyzers.backends.pl_utils import ensure_frame, dtypes_dict, describe_dict
from lumen.analyze_data.analyzers.backends.stats_runner import run_statistics
from lumen.analyze_data.analyzers.backends.abstract_analyzers import (
...
from lumen.statistics.time_series.seasonal import SeasonalDecomposition
...
from lumen.statistics.inferential.chi_square import ChiSquareTestCalculator
from lumen.statistics.inferential.correlation_significance import CorrelationSignificanceCalculator
...
# ── DOMAIN 6 IMPORTS ──────────────────────────────────────────────────────────
from lumen.statistics.nlp.text_basic_stats import TextBasicStatsCalculator
from lumen.statistics.nlp.word_frequency import WordFrequencyCalculator
from lumen.statistics.nlp.sentiment_analysis import SentimentAnalysisCalculator
from lumen.statistics.nlp.topic_detection import TopicDetectionCalculator
from lumen.statistics.nlp.language_detection import LanguageDetectionCalculator
from lumen.statistics.nlp.text_similarity import TextSimilarityCalculator
from lumen.statistics.nlp.named_entity_density import NamedEntityDensityCalculator
...
# ── DOMAIN 7 IMPORTS ──────────────────────────────────────────────────────────
from lumen.statistics.segmentation.kmeans_clusters import KMeansClusterCalculator
from lumen.statistics.segmentation.rfm_segmentation import RFMSegmentationCalculator
from lumen.statistics.segmentation.cohort_analysis import CohortAnalysisCalculator
from lumen.statistics.segmentation.population_splits import PopulationSplitsCalculator
from lumen.statistics.segmentation.dbscan_clusters import DBSCANClusterCalculator
from lumen.statistics.segmentation.hierarchical_clusters import HierarchicalClusterCalculator
...
# ── DOMAIN 10 IMPORTS ─────────────────────────────────────────────────────────
from lumen.statistics.graphs.network_density import NetworkDensityCalculator
from lumen.statistics.graphs.centrality_analysis import CentralityAnalysisCalculator
from lumen.statistics.graphs.community_detection import CommunityDetectionCalculator
from lumen.statistics.graphs.path_analysis import PathAnalysisCalculator

# ── DOMAIN 11 IMPORTS ─────────────────────────────────────────────────────────
from lumen.statistics.survival.kaplan_meier import KaplanMeierCalculator
from lumen.statistics.survival.hazard_rate import HazardRateCalculator
from lumen.statistics.survival.event_density import EventDensityCalculator
from lumen.statistics.survival.time_to_event import TimeToEventCalculator
...
class AnalysePowerAnalysisPolars(AbstractAnalysePowerAnalysis[pl.DataFrame]):
    ...
    def analyze(self, **kwargs) -> dict:
        ...
        if analysis_type == "observed_power":
            ...
            from lumen.statistics.inferential.effect_size import CohensDCalculator
            group_a = self._data_frame[col_a].dropna().to_numpy()
            group_b = self._data_frame[col_b].dropna().to_numpy()
...
# ── DOMAIN 5 IMPORTS ──────────────────────────────────────────────────────────
from lumen.statistics.ml_support.feature_variance import FeatureVarianceCalculator
from lumen.statistics.ml_support.feature_selection import FeatureSelectionCalculator
from lumen.statistics.ml_support.feature_importance import FeatureImportanceCalculator
from lumen.statistics.ml_support.dimensionality_reduction import DimensionalityReductionCalculator
from lumen.statistics.ml_support.class_imbalance import ClassImbalanceCalculator
from lumen.statistics.ml_support.model_residuals import ModelResidualsCalculator
from lumen.statistics.ml_support.learning_curve import LearningCurveCalculator
from lumen.statistics.ml_support.cross_validation import CrossValidationCalculator
...
# ── DOMAIN 4 IMPORTS ──────────────────────────────────────────────────────────
from lumen.statistics.time_series.volatility import VolatilityCalculator
from lumen.statistics.time_series.momentum import MomentumCalculator
from lumen.statistics.time_series.moving_averages import MovingAveragesCalculator
from lumen.statistics.time_series.stationarity import StationarityCalculator
from lumen.statistics.time_series.lag_features import LagFeaturesCalculator
from lumen.statistics.time_series.change_points import ChangePointDetector
from lumen.statistics.time_series.forecast_accuracy import ForecastAccuracyCalculator
from lumen.statistics.time_series.cyclical_patterns import CyclicalPatternsCalculator
from lumen.statistics.time_series.rolling_statistics import RollingStatisticsCalculator
...
class AnalyseNetworkDensityPolars(AbstractAnalyseNetworkDensity[pl.DataFrame]):
...
class AnalyseKaplanMeierPolars(AbstractAnalyseKaplanMeier[pl.DataFrame]):
