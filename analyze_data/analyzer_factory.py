...
from analyze_data.analyzers.backends.abstract_analyzers import AbstractBaseDataAnalysis
...
def _register_analyzers() -> None:
    from analyze_data.analyzers.backends import pandas_impl, polars_impl, spark_impl
